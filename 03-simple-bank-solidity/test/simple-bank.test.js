...
describe('SimpleBank', () => {
   ...
   it('should mark addresses as enrolled', async () => {
      ...
      expect(await instance.enrolled(alice.address))
         .to.be.true
   })
   ...
   it('should not mark unenrolled users as enrolled', async () => {
      ...
      expect(await instance.enrolled(owner.address)).to.be.false
   })
   ...
   it('should deposit correct amount', async () => {
      ...
      expect(await instance.getBalance())
   ...
   it('should withdraw correct amount', async () => {
      ...
      expect(await instance.getBalance()).to.equal(0)
   })
